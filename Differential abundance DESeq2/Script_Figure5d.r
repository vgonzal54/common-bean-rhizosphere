...
library(VennDiagram) # For intersection 
...
ggvenn(Venn_Up, fill_color=c("white", "white", "white"), set_name_color="black")

# Save the Venn diagram as a PDF
pdf("Venn_Diagram_Genus_LFC2_pvalue005.pdf", width = 8, height = 7, bg = "white", paper = "A4")   
ggvenn(Venn_Up, fill_color=c("white", "white", "white"), set_name_color="black")
dev.off()
