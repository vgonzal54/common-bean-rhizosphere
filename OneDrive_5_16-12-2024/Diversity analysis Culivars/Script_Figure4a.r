...
# Read metadata file
metdata <- read.table("Metadata_aceccions_edit.tsv", row.names=1, header=TRUE, sep='\t', check.names=TRUE, stringsAsFactors=TRUE)
...
# Save plot as a PDF
pdf(file="D:/Documentos/Doctorado/Doctorado_Decimo_semestre/Revision_Articulo/Abundanci_Rel_Phylum/R_Result/Var_colors_5.pdf", 
