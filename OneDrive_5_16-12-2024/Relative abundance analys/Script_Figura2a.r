...
unique(Tabla_Genus$Genus) # Viewunique Genus names
...
# Save plot as a PDF
pdf(file="D:/Documentos/Doctorado/Doctorado_Decimo_semestre/Revision_Articulo/Abundanci_Rel_Phylum/R_Result/PS_colors_6.pdf", 
